...
(function() {
  $(function() {
    var apply_filestyle, numbering_row_order, switch_delete_links_and_sortable;
    numbering_row_order = function(list) {
      var i, items;
      ...
      return items.each(function() {
        ...
        return item.find('input:hidden.row_order').val(i++);
      });
    };
    switch_delete_links_and_sortable = function(list) {
      var items;
      items = list.find('div.item:visible');
      return items.each(function() {
        var item;
        ...
        if (items.length === 1) {
          ...
          return list.sortable({
            ...
            update: function(e, ui) {
              items = $(this);
              return numbering_row_order(items);
            }
          });
        }
      });
    };
    apply_filestyle = function() {
      return $('.filestyle').each(function() {
        var $this, options;
        $this = $(this);
        options = {
        ...
        return $this.filestyle(options);
      });
    };
    $('form').on('click', '.add_field', function(event) {
      var items, regexp, time;
    ...
    return $('div.items').each(function() {
      var item;
      item = $(this);
      return switch_delete_links_and_sortable(item);
    });
  });
